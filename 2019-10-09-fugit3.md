...
<h1 align="center" style="font-size:30px;">
  <br>
  <a href="https://www.vulnhub.com/entry/tempus-fugit_2,364/">Tempus Fugit 3</a>
  <br>
</h1>
...
When we click on `Login` we get two fields to enter username and password so I tried to do SQLi on those but that also didn't worked. So this was the time to ask [@andreas] for hint. He said `test for SSTI`. I entered `IP/{{ 7+7 }}` and got error saying there is no URL `IP/14`, this mean it's vulnerable to SSTI.
